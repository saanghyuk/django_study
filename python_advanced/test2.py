...
print('EX 4-3 ', 3 in i1[1:10]) # contain을 파이썬이 알아서 만든 것.
print('EX 4-4 ', [i for i in i1]) # iter을 파이썬이 알아서 만든 것.

print('EX 4-5 ', reversed(i1)) # iter을 파이썬이 알아서 만든 것.
...
 
# from colections.abc import Sequence
